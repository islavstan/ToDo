package com.islavdroid.todo.flc;
...
public class SwipeStack extends ViewGroup {
    ...
    public static final boolean DEFAULT_STACK_ORDER_TOP = true;
    ...
    private void readAttributes(AttributeSet attributeSet) {
        ...
        try {
            ...
            mStackOrderTop =attrs.getBoolean(R.styleable.SwipeStack_stack_order_top, DEFAULT_STACK_ORDER_TOP);
        } finally {
            attrs.recycle();
        }
    }
    ...
    private void reorderItems() {
        for (int x = 0; x < getChildCount(); x++) {
         ...
         //   int newPositionY;
          //  if(mStackOrderTop){
                 int newPositionY =  -distanceToViewAbove + getPaddingTop();
           // }else { newPositionY = distanceToViewAbove + getPaddingTop();}
